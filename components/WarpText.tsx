...
interface BuildTextCanvasOptions {
...
const buildTextCanvas = ({ container, width, height, dpr, props }: BuildTextCanvasOptions) => {
...
const syncUniforms = (program: any, props: TextCanvasProps) => {
...
const WarpText: React.FC<WarpTextProps> = ({
  ...
  const propsRef = useRef<TextCanvasProps>({
    text,
    color,
    fontSize,
    fontWeight,
